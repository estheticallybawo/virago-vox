...
const AdaLovelace = () => {
  ...
  const profile = {
    ...
    timeline: [
      ...
      {
        year: "1835",
        event: "Married William King-Noel, later Earl of Lovelace",
        type: "personal",
      },
      {
        year: "1842-1843",
      ...
      {
        year: "1843",
        event: "Published the first algorithm for the Analytical Engine",
        type: "achievement",
      },
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(88, 28, 135, 0.8), rgba(88, 28, 135, 0.6)), url(${profile.heroImage})`,
        }}
      >
        <div className="container mx-auto px-4 max-w-7xl">
                    ...
                    <CollapsibleTrigger className="flex items-center justify-between w-full cursor-pointer">
                      ...
                      <i
                        className={`fas fa-chevron-${
                          expandedSections.biography ? "up" : "down"
                        } text-purple-600`}
                      ></i>
                    </CollapsibleTrigger>
                    <CollapsibleContent>
                      <CardContent className="pt-6">
                        ...
                        <div className="mt-6 p-4 bg-purple-50 rounded-lg">
                          ...
                          <p className="text-sm text-purple-700">
                            Marie Curie lived during a time of rapid scientific
                            advancement and social change. Her work coincided
                            with the discovery of X-rays and the early
                            understanding of atomic structure, making her
                            contributions even more remarkable given the limited
                            resources and gender barriers of her era.
                          </p>
                        </div>
                      </CardContent>
                    </CollapsibleContent>
                    ...
                    <div className="space-y-6">
                      {profile.timeline.map((event, index) => (
                        <div key={index} className="relative flex items-start">
                          <div
                            className={`absolute left-2 w-4 h-4 rounded-full border-2 border-white shadow-md ${
                              event.type === "birth"
                                ? "bg-green-500"
                    ...
                    <CardHeader>
                      ...
                      >
                        <CollapsibleTrigger className="flex items-center justify-between w-full cursor-pointer">
                          ...
                          <i
                            className={`fas fa-chevron-${
                              expandedSections[section.key] ? "up" : "down"
                            } text-purple-600`}
                          ></i>
                        </CollapsibleTrigger>
                        <CollapsibleContent>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">
                      Radioactivity research, Nobel Prizes
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {profile.relatedProfiles.map((related, index) => (
                      <div
                        key={index}
                        className="flex items-center space-x-3 cursor-pointer hover:bg-purple-50 p-2 rounded-lg transition-colors"
                      >
                        <img
                          src={related.image}
                          alt={related.name}
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {profile.relatedProfiles.map((related, index) => (
              <Card
                key={index}
                className="overflow-hidden border-none shadow-lg hover:shadow-xl transition-all group cursor-pointer"
              >
      ...
      <section className="py-16 bg-gradient-to-r from-purple-900 to-purple-700 text-white">
        <div className="container mx-auto px-4 max-w-7xl text-center">
          <h2 className="text-3xl font-bold mb-6">
            Inspired by Marie Curie's Legacy?
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto text-purple-100">
            Discover more remarkable women who changed the world through
