...
const Archive = () => {
  ...
  const featuredWomen = [
    {
      ...
      period: "1900-1978",
      impact:
        "Nigerian educator, political campaigner, women's rights activist and traditional aristocrat who was the first woman to drive a car in Nigeria.",
    ...
    },
    {
      ...
      period: "1920-1958",
      impact:
        "English chemist whose work was central to understanding the molecular structures of DNA, RNA, viruses, coal, and graphite.",
    ...
    },
    {
      ...
      period: "1916-2000",
      impact:
        "Sri Lankan politician who became the world's first female prime minister in 1960.",
    ...
    },
    {
      ...
      period: "1940-2011",
      impact:
        "Kenyan environmental political activist and the first African woman to win the Nobel Peace Prize.",
    ...
    },
    {
      ...
      period: "1815-1852",
      impact:
        "English mathematician and writer, known for her work on Charles Babbage's Analytical Engine. She is often regarded as the first computer programmer.",
      category: ["Science", "Technology", "Mathematics"],
      image: "./Lovelace.jpg",
      href: "/profile/ada-lovelace"
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="border-b border-gray-100 bg-white sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-10">
            <a
              href="./home"
              className="text-gray-800 hover:text-purple-600 font-medium cursor-pointer"
            >
              Home
            </a>
            <a
              href="./archive"
              className="text-purple-700 hover:text-purple-600 font-bold cursor-pointer"
            >
              Archive
            </a>
            <a
        ...
        <div className="container mx-auto px-4 py-20 md:py-32 relative z-10">
          <div className="max-w-2xl text-white">
            ...
            <p className="text-lg md:text-xl mb-8 text-white/90">
              The world's first AI-powered female impact archive, preserving and
                ...
                <Card className="overflow-hidden h-full flex flex-col shadow-md hover:shadow-lg transition-shadow duration-300">
                  ...
                  <div className="p-5 flex-grow flex flex-col">
                    ...
                    <a href="./profile">
                      <Button
                        variant="link"
                        className="text-teal-600 hover:text-teal-700 p-0 justify-start !rounded-button whitespace-nowrap cursor-pointer"
                      >
                        Read full story{" "}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {featuredWomen.map((woman) => (
              <Card
                key={woman.id}
                className="overflow-hidden shadow hover:shadow-md transition-shadow duration-300"
              >
                <div className="flex h-full">
                  ...
                  <div className="w-2/3 p-4">
                    ...
                    <a href={woman.href}>
                      <Button
                        variant="link"
                        className="text-teal-600 hover:text-teal-700 p-0 h-auto text-sm !rounded-button whitespace-nowrap cursor-pointer"
                      >
                        View profile
                      </Button>
                    </a>
          ...
          <div className="mt-10 text-center">
            <a href="./gallery">
              <Button
                variant="outline"
                className="border-purple-300 text-purple-700 hover:bg-purple-50 !rounded-button whitespace-nowrap cursor-pointer"
              >
                Load More Stories{" "}
                <FaChevronDown className="fa-solid fa-chevron-down ml-2" />
              </Button>
            </a>
          </div>
        </div>
      ...
      <section
        id="submit"
        className="py-16 bg-gradient-to-br from-purple-50 via-white to-teal-50"
      >
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-gray-600 text-center mb-10 max-w-2xl mx-auto">
              Know an unsung heroine whose story deserves to be told? Submit her
              name and our AI will generate a first draft that you can refine
              before publication.
            </p>
              ...
              >
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Textarea
                      placeholder="e.g., First woman to win a Nobel Prize and the only person to win in multiple scientific fields."
              ...
              >
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between">
                    <Button
                      variant="outline"
                      className="border-gray-300 !rounded-button whitespace-nowrap cursor-pointer"
                    >
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                      ...
                      <p className="text-xs text-gray-400">
                        Supported formats: JPG, PNG, TIFF (max 5MB)
                      </p>
                      <input type="file" />
                      <Button
                        variant="outline"
                        className="mt-4 text-sm border-gray-300 !rounded-button whitespace-nowrap cursor-pointer"
                      >
                        Select File
                      </Button>
                    </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <label htmlFor="terms" className="text-sm text-gray-700">
                      ...
                      my knowledge and I have permission to share any uploaded
                      images.
                    </label>
                  </div>
                  <div className="flex justify-between">
                    ...
                    <Button className="bg-purple-600 hover:bg-purple-700 text-white !rounded-button whitespace-nowrap cursor-pointer">
                      Submit Story{" "}
                      <FaPaperPlane className="fa-solid fa-paper-plane ml-2" />
                    </Button>
                  </div>
                </div>
              </TabsContent>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto m-8">
              Join forward-thinking organizations in supporting our mission to
              preserve and amplify women's voices throughout history.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-gray-700 mb-6">
                  Partner with ViragoVOX to help rewrite history with women at
                  the center. Your organization can support our mission through
                  sponsorships, content collaborations, or technology
                  partnerships.
                </p>
                <ul className="space-y-2 mb-6">
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-700">
                      Brand visibility on a platform dedicated to equality
                    </span>
                  </li>
                  <li className="flex items-start">
                    <i className="fa-solid fa-check text-teal-500 mt-1 mr-2"></i>
                    <span className="text-gray-700">
                      Co-created content highlighting women in your field
                    </span>
                  </li>
                  <li className="flex items-start">
                    <i className="fa-solid fa-check text-teal-500 mt-1 mr-2"></i>
                    <span className="text-gray-700">
                      Access to our growing community of history enthusiasts
                    </span>
                  </li>
                </ul>
                <Button className="bg-teal-500 hover:bg-teal-600 text-white !rounded-button whitespace-nowrap cursor-pointer">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-400 mb-4">
                A digital sanctuary preserving and amplifying the voices of
            ...
            <div>
              ...
              <p className="text-gray-400 mb-4">
                Subscribe to our newsletter for weekly updates on new stories
                and features.
              </p>
              <div className="flex">
                <Input
