      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-24 md:py-32 relative z-10 max-w-7xl">
          <div className="max-w-2xl text-white">
            <p className="text-teal-300 font-medium mb-3 text-lg">
              History is being written right now. Who's telling your story?
            </p>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              Rewriting History Through Women's Voices
            </h1>
            <p className="text-xl mb-8 text-purple-50">
              Not another women's platform. A cultural revolution in digital
              permanence.
            </p>
            <p className="text-lg mb-10 text-purple-100">
              ViragoVOX exists to correct the record and spotlight the
              brilliance of women who shaped the world, yet too often went
              unrecognized.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a href="">
                <Button
                  variant="outline"
                  className="border-2 border-white text-white hover:bg-white/10 font-bold text-lg px-8 py-5.5 !rounded-button cursor-pointer whitespace-nowrap"
                >
                  Claim Your Legacy
                </Button>
              </a>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Discover the extraordinary women whose stories deserve to be told,
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="p-6">
              <div className="mb-4">
                ...
                <span className="ml-3 bg-teal-100 text-teal-800 px-3 py-1 rounded-full text-sm font-medium">
                  1956 - Present
                </span>
              </div>
              <h3 className="text-3xl font-bold mb-4">Dr. Mae Jemison</h3>
              <p className="text-lg mb-6">
                Physician, engineer, and NASA astronaut who became the first
                Black woman to travel in space when she served as a mission
                specialist aboard the Space Shuttle Endeavour in 1992.
              </p>
              <p className="text-gray-700 mb-8">
                Beyond her groundbreaking space mission, Dr. Jemison founded The
                Jemison Group, a technology consulting firm. She's also the
                principal of the 100 Year Starship project, working to ensure
                human interstellar space travel capabilities within the next
                century. Her work spans medicine, technology, education, and
                social science, embodying the interdisciplinary approach needed
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <div className="flex space-x-2">
                  <Button
                    variant="outline"
                    size="icon"
                    className="rounded-full border-gray-300 !rounded-button cursor-pointer whitespace-nowrap"
                  >
                    <FaShareAlt />
                  </Button>
                  <Button
      ...
      <section id="mission" className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Rewriting history from a woman-centered lens, preserving legacies
              with the power, elegance, and clarity they deserve.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-purple-100 shadow-md hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p>
                  We're building a comprehensive digital archive of women's
                  contributions throughout history, from community changemakers
                  to global icons whose stories deserve more depth.
                </p>
              </CardContent>
            </Card>
            <Card className="border-purple-100 shadow-md hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p>
                  ViragoVOX is where her story lives on. We amplify the voices
                  of women forgotten, overlooked, or never given the mic,
            ...
            <Card className="border-purple-100 shadow-md hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p>
                  We're not just documenting history—we're correcting it. By
                  centering women's experiences and achievements, we're creating
                  a more accurate and complete historical narrative.
                </p>
              </CardContent>
            </Card>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-gray-700 mb-6">
                  Despite making up half the world's population, women's
                  stories, achievements, and contributions are dramatically
                  underrepresented in our cultural archives, educational
                  materials, and public discourse.
                </p>
              ...
              <div className="space-y-6">
                <div className="bg-white p-6 rounded-xl shadow-sm">
                  ...
                  <ScrollArea className="h-64">
                    <p className="mb-4">
                      This isn't performative. This is permanent. We believe
                      that women's stories deserve to be told with the same
                      reverence, detail, and permanence as those of their male
                      counterparts.
                    </p>
                    <p className="mb-4">
                      We reject the notion that women's achievements are
                      "alternative history." They are history—essential,
                      powerful, and transformative.
                    </p>
                    <p className="mb-4">
                      ViragoVOX exists to correct the record, to spotlight
                      brilliance that shaped our world yet too often went
                      unrecognized, and to ensure that future generations
                      inherit a more complete understanding of our shared past.
                    </p>
                    <p>
                      Join us in building the first platform where women's
                      legacies are preserved with the power, elegance, and
      ...
      >
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Explore our growing collection of stories, profiles, and
              historical records celebrating women's impact across time and
              fields.
            </p>
          </div>
                ...
                {[
                  {
                    ...
                    era: "1867-1934",
                    description:
                      "Physicist and chemist who conducted pioneering research on radioactivity, becoming the first woman to win a Nobel Prize and the only person to win Nobel Prizes in multiple scientific fields.",
                  ...
                  },
                  {
                    ...
                    era: "1907-1954",
                    description:
                      "Mexican painter known for her many portraits, self-portraits, and works inspired by nature and artifacts of Mexico, exploring questions of identity, gender, class, and race.",
                  ...
                  },
                  {
                    ...
                    era: "1940-2011",
                    description:
                      "Kenyan environmental and political activist who founded the Green Belt Movement and became the first African woman to receive the Nobel Peace Prize.",
      ...
      <section id="contribute" className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Join our community of historians, writers, researchers, and
              advocates helping to preserve and amplify women's stories.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
              <div className="bg-purple-50 rounded-2xl p-8 shadow-sm">
                ...
                <p className="mb-6">
                  Help shape the future of ViragoVOX by sharing your thoughts on
                  which stories matter most to you and how we can better
                  preserve women's legacies.
                </p>
                <form className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">
                      Which fields would you like to see more representation in?
                    </label>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">
                      Is there a specific woman whose story you believe deserves
                      more recognition?
                    </label>
                    <Input
                      type="text"
            ...
            <div className="order-1 md:order-2 space-y-8">
              <div className="bg-gradient-to-r from-purple-100 to-teal-100 p-6 rounded-xl">
                ...
                <p className="mb-4">
                  Have a story about an impactful woman in history or your
                  personal life? Share it with our community and help expand our
              ...
              <div className="bg-gradient-to-r from-teal-100 to-purple-100 p-6 rounded-xl">
                ...
                <p className="mb-4">
                  Join our team of volunteer researchers helping to uncover and
                  document women's stories from archives, historical records,
                  and oral histories.
                </p>
              ...
              <div className="bg-gradient-to-r from-purple-100 to-teal-100 p-6 rounded-xl">
                ...
                <p className="mb-4">
                  Are you an expert on women's history or have a personal
                  connection to a remarkable woman's story? We'd love to feature
                  you on our podcast.
                </p>
                <Button className="bg-white text-purple-700 hover:bg-gray-100 !rounded-button cursor-pointer whitespace-nowrap">
                  Nominate a Guest
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">
              Your Brand Will Look Great as Our Partner
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Join us in commitment to amplifying women's voices and preserving
              their legacies.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-purple-100 shadow-md hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  Connect with our community of history enthusiasts, educators,
                  and change-makers
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border-purple-100 shadow-md hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  Support initiatives that make a real difference in preserving
                  women's history
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border-purple-100 shadow-md hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  Associate with values of innovation, diversity, and
                  empowerment
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="space-y-6">
                  <div className="bg-white p-4 rounded-lg shadow-sm">
                    ...
                    <p className="text-gray-600 text-sm">
                      Universities, museums, and educational technology
                      companies committed to expanding historical narratives and
                  ...
                  <div className="bg-white p-4 rounded-lg shadow-sm">
                    ...
                    <p className="text-gray-600 text-sm">
                      Forward-thinking publishers, media companies, and content
                      creators focused on amplifying diverse voices and stories.
                    </p>
                  </div>
                  <div className="bg-white p-4 rounded-lg shadow-sm">
                    <h4 className="font-semibold mb-2 flex items-center">
                    ...
                    <p className="text-gray-600 text-sm">
                      Companies with strong commitments to diversity, equity,
                      and social impact, particularly those advancing women's
                      leadership.
                    </p>
                  </div>
                </div>
              ...
              <div>
                ...
                <p className="text-gray-600 mb-6">
                  Ready to make history together? Let's discuss how we can
                  create meaningful impact through partnership.
                </p>
                <div className="space-y-4">
                  <Dialog>
                    <DialogTrigger asChild>
                      <Button
                        id="request-partnership-btn"
                    ...
                    <DialogContent className="sm:max-w-[500px]">
                      <form onSubmit={handlePartnershipSubmit}>
                        <DialogHeader>
                          ...
                          <DialogDescription>
                            Fill out this form to explore partnership
                            opportunities with ViragoVOX.
                          </DialogDescription>
                        </DialogHeader>
                            ...
                            <div className="space-y-2">
                                ...
                                <Checkbox
                                  ...
                                  onCheckedChange={(checked) =>
                                    setPartnershipForm({
                                      ...
                                      interests: {
                                        ...partnershipForm.interests,
                                        contentCollaboration: checked,
                                      },
                                    })
                                  }
                                />
                                <Label htmlFor="contentCollaboration">
                              ...
                              <div className="flex items-center space-x-2">
                                <Checkbox
                                  id="eventSponsorship"
                                  checked={
                                    partnershipForm.interests.eventSponsorship
                                  }
                                  onCheckedChange={(checked) =>
                                    setPartnershipForm({
                                      ...partnershipForm,
                                      interests: {
                                        ...partnershipForm.interests,
                                        eventSponsorship: checked,
                                      },
                                    })
                                  }
                                />
                                <Label htmlFor="eventSponsorship">
                                  Event Sponsorship
                                </Label>
                              </div>
                              <div className="flex items-center space-x-2">
                                <Checkbox
                                  ...
                                  onCheckedChange={(checked) =>
                                    setPartnershipForm({
                                      ...
                                      interests: {
                                        ...partnershipForm.interests,
                                        educationalPrograms: checked,
                                      },
                                    })
                                  }
                                />
                                <Label htmlFor="educationalPrograms">
                  ...
                  <p className="text-sm text-gray-500 text-center">
                    Join us in our mission to preserve and amplify women's
      ...
      <section className="py-20 bg-purple-50">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Connect with others passionate about preserving and celebrating
              women's legacies throughout history.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-none shadow-md">
              ...
              <CardContent>
                <p className="mb-4">
                  Discuss, debate, and discover alongside historians, writers,
                  and enthusiasts in our active online community.
                </p>
            ...
            <Card className="border-none shadow-md">
              ...
              <CardContent>
                <p className="mb-4">
                  Attend virtual and in-person events including writing
                  workshops, research seminars, and guest lectures.
                </p>
            ...
            <Card className="border-none shadow-md">
              ...
              <CardContent>
                <p className="mb-4">
                  Receive weekly updates featuring new profiles, podcast
                  episodes, and opportunities to contribute.
                </p>
              ...
              {[
                {
                  ...
                  quote:
                    "ViragoVOX has become an invaluable resource for my students. It's filling critical gaps in our historical understanding and providing much-needed context for women's contributions.",
                  avatar: "S",
                },
                {
                  ...
                  quote:
                    "Being able to document my grandmother's story and her impact on our community has been healing. Now her legacy will live on beyond our family memories.",
                  avatar: "M",
                },
                {
                  name: "Aisha Patel",
                  role: "Researcher",
                  quote:
                    "The collaborative research model at ViragoVOX is revolutionary. Together, we're uncovering stories that would otherwise remain buried in archives or forgotten entirely.",
                  avatar: "A",
                },
                {
                  name: "Emma Chen",
                  ...
                  quote:
                    "Each episode of the podcast introduces me to women I should have learned about in school but never did. It's both enlightening and frustrating to realize how much has been omitted from our education.",
                  avatar: "E",
                },
      ...
      <section className="py-20 bg-gradient-to-r from-purple-900 to-purple-700 text-white">
        <div className="container mx-auto px-4 max-w-7xl text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto text-purple-100">
            Join us in building the first platform where women's legacies are
            preserved with the power, elegance, and clarity they deserve.
          </p>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 mb-4">
                Rewriting history from a woman-centered lens, preserving
                legacies with the power, elegance, and clarity they deserve.
              </p>
              <div className="flex space-x-4">
                <Link
                  href="https://x.com/theviragovox"
                  className="h-10 w-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-teal-600 transition-colors cursor-pointer"
                  target="_blank"
                ...
                <Link
                  href="https://www.instagram.com/the_viragovox"
                  className="h-10 w-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-teal-600 transition-colors cursor-pointer"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                ...
                <Link
                  href="https://www.linkedin.com/company/viragovox"
                  className="h-10 w-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-teal-600 transition-colors cursor-pointer"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                ...
                <Link
                  href="https://tiktok.com/@the.viragovox"
                  className="h-10 w-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-teal-600 transition-colors cursor-pointer"
                  target="_blank"
                  rel="noopener noreferrer"
                >
