...
const GalleryPage = () => {
  ...
  const profiles = [
    ...
    },
    {
      ...
      image:
        "https://readdy.ai/api/search-image?query=A%2520professional%2520portrait%2520photograph%2520of%2520Wangari%2520Maathai%2520smiling%2520while%2520planting%2520a%2520tree%252C%2520wearing%2520colorful%2520traditional%2520Kenyan%2520clothing%252C%2520in%2520a%2520natural%2520outdoor%2520setting%2520with%2520trees%2520and%2520greenery%2520in%2520the%2520background%252C%2520warm%2520natural%2520lighting%2520highlighting%2520her%2520joyful%2520expression%252C%2520photorealistic%2520style&width=400&height=500&seq=wangari-maathai-1&orientation=portrait",
    },
    {
      id: 4,
      name: "Ada Lovelace",
      ...
      years: "1815-1852",
      description:
        "English mathematician and writer, known for her work on Charles Babbage's proposed mechanical general-purpose computer, the Analytical Engine. She was the first to recognize that the machine had applications beyond pure calculation.",
      image:
        "https://readdy.ai/api/search-image?query=A%2520professional%2520portrait%2520photograph%2520of%2520Ada%2520Lovelace%2520in%2520Victorian%2520era%2520dress%252C%2520sitting%2520at%2520a%2520desk%2520with%2520mathematical%2520papers%2520and%2520early%2520computing%2520concepts%252C%2520elegant%2520pose%2520with%2520thoughtful%2520expression%252C%2520soft%2520lighting%2520highlighting%2520her%2520intelligence%2520and%2520determination%252C%2520neutral%2520background%2520with%2520period%2520appropriate%2520elements&width=400&height=500&seq=ada-lovelace-1&orientation=portrait",
...

    {
      ...
      years: "1920-1958",
      description:
        "English chemist and X-ray crystallographer whose work was central to the understanding of the molecular structures of DNA, RNA, viruses, coal, and graphite. Her X-ray diffraction images of DNA led to the discovery of the DNA double helix.",
      image:
        "https://readdy.ai/api/search-image?query=A%2520professional%2520portrait%2520photograph%2520of%2520Rosalind%2520Franklin%2520in%2520a%2520laboratory%2520coat%2520working%2520with%2520X-ray%2520crystallography%2520equipment%252C%2520focused%2520expression%2520showing%2520her%2520scientific%2520dedication%252C%2520clean%2520laboratory%2520setting%2520with%2520scientific%2520instruments%2520in%2520background%252C%2520warm%2520lighting%2520highlighting%2520her%2520features%252C%2520photorealistic%2520style&width=400&height=500&seq=rosalind-franklin-1&orientation=portrait",
    },
    {
      id: 6,
    ...
    },
    {
      ...
      years: "1897-1937",
      description:
        "American aviation pioneer and author. Earhart was the first female aviator to fly solo across the Atlantic Ocean. She set many other records, wrote best-selling books about her flying experiences, and was instrumental in the formation of The Ninety-Nines.",
      image:
        "https://readdy.ai/api/search-image?query=A%2520professional%2520portrait%2520photograph%2520of%2520Amelia%2520Earhart%2520in%2520her%2520iconic%2520aviation%2520gear%252C%2520leather%2520jacket%2520and%2520cap%252C%2520standing%2520confidently%2520next%2520to%2520a%2520vintage%2520aircraft%252C%2520determined%2520expression%2520showing%2520her%2520pioneering%2520spirit%252C%2520warm%2520outdoor%2520lighting%252C%2520airfield%2520background%252C%2520photorealistic%2520style&width=400&height=500&seq=amelia-earhart-1&orientation=portrait",
    },
    {
      id: 9,
      name: "Cleopatra",
      ...
      years: "69-30 BCE",
      description:
        "The last active ruler of the Ptolemaic Kingdom of Egypt. As a member of the Ptolemaic dynasty, she was a descendant of its founder Ptolemy I Soter, a Macedonian Greek general and companion of Alexander the Great.",
      image:
        "https://readdy.ai/api/search-image?query=A%2520professional%2520artistic%2520representation%2520of%2520Cleopatra%2520in%2520royal%2520Egyptian%2520attire%2520with%2520traditional%2520headdress%2520and%2520jewelry%252C%2520regal%2520pose%2520conveying%2520her%2520power%2520and%2520intelligence%252C%2520warm%2520golden%2520lighting%2520highlighting%2520her%2520features%252C%2520neutral%2520background%2520with%2520subtle%2520ancient%2520Egyptian%2520architectural%2520elements%252C%2520photorealistic%2520style&width=400&height=500&seq=cleopatra-1&orientation=portrait",
    },
    {
      id: 10,
      name: "Jane Austen",
    ...
    },
    {
      ...
      years: "1797-1883",
      description:
        "American abolitionist and women's rights activist. Truth was born into slavery but escaped with her infant daughter to freedom in 1826. She gave herself the name Sojourner Truth in 1843 and became a powerful advocate for abolition, women's rights, and civil rights.",
      image:
        "https://readdy.ai/api/search-image?query=A%2520professional%2520artistic%2520representation%2520of%2520Sojourner%2520Truth%2520in%2520mid-19th%2520century%2520attire%252C%2520dignified%2520pose%2520conveying%2520her%2520strength%2520and%2520determination%2520as%2520an%2520abolitionist%2520and%2520womens%2520rights%2520activist%252C%2520warm%2520lighting%2520highlighting%2520her%2520powerful%2520presence%252C%2520neutral%2520background%2520with%2520subtle%2520period%2520appropriate%2520elements%252C%2520photorealistic%2520style&width=400&height=500&seq=sojourner-truth-1&orientation=portrait",
    },
    {
      id: 12,
      name: "Hedy Lamarr",
      ...
      years: "1914-2000",
      description:
        "Austrian-American actress, inventor, and film producer. At the beginning of World War II, she and composer George Antheil developed a radio guidance system using frequency-hopping spread spectrum technology, which later became the basis for Wi-Fi, Bluetooth, and GPS.",
      image:
        "https://readdy.ai/api/search-image?query=A%2520professional%2520portrait%2520photograph%2520of%2520Hedy%2520Lamarr%2520in%2520elegant%25201940s%2520attire%252C%2520glamorous%2520Hollywood%2520style%2520combined%2520with%2520an%2520intelligent%2520expression%2520conveying%2520her%2520dual%2520identity%2520as%2520actress%2520and%2520inventor%252C%2520classic%2520studio%2520lighting%2520highlighting%2520her%2520striking%2520features%252C%2520neutral%2520background%2520with%2520subtle%2520technical%2520drawings%2520visible%252C%2520photorealistic%2520style&width=400&height=500&seq=hedy-lamarr-1&orientation=portrait",
      ...
      <section className="py-16 bg-gradient-to-r from-purple-900 to-purple-700 text-white">
        <div className="container mx-auto px-4 max-w-7xl text-center">
          <h2 className="text-3xl font-bold mb-6">
            Know a remarkable woman whose story deserves to be told?
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto text-purple-100">
            Help us expand our archive by contributing stories of women who have
            made significant impacts throughout history.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              variant="outline"
              className="border-2 border-white text-white hover:bg-white/10 !rounded-button cursor-pointer whitespace-nowrap"
            >
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <Button
                  variant="ghost"
                  size="icon"
                  className="rounded-full text-gray-400 hover:text-white hover:bg-gray-800 !rounded-button cursor-pointer whitespace-nowrap"
                >
